...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final ChromecastLibraryAccessors laccForChromecastLibraryAccessors = new ChromecastLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>chromecast</b>
     */
    public ChromecastLibraryAccessors getChromecast() {
        return laccForChromecastLibraryAccessors;
    }
    ...
    public static class ChromecastLibraryAccessors extends SubDependencyFactory {

        public ChromecastLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>sender</b> with <b>com.pierfrancescosoffritti.androidyoutubeplayer:chromecast-sender</b> coordinates and
         * with version reference <b>chromecastSender</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getSender() {
            return create("chromecast.sender");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>chromecastSender</b> with value <b>0.28</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
